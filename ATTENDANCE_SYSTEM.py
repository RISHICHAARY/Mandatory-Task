...
def Dashboard(Usr):
        ...
        def Set():
                ...
                def Semn(A):
                        ...
                        RS=Button(Sub1,font=("vardana",15,'bold'),text="REMOVE STUDENT",bg='#ffde59',bd=0,padx=10,command=lambda:[Rs(window1,Sub)]).grid(row=1,column=0,padx=5,pady=5)
                ...
                def Cp(X,Y):
                        ...
                        lg.grid(row=1,column=0,padx=5,pady=5)
                        def Fcp(Asd):
                                vi=Asd.get()
